...
def time_and_download_files_from_s3_glacier(ssh):
    download_files_commands = {
        "download 1mb file from glacier storage": "aws s3 cp s3://seng533-glacier-group15/test-upload-1mb-agent1.file downloaded-1mb.file",
        "download 100mb file from glacier storage": "aws s3 cp s3://seng533-glacier-group15/test-upload-10mb-agent1.file downloaded-10mb.file",
    }
